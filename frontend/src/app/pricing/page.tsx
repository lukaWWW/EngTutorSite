    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6 dark:text-white">Standard Pricing</h2>
            <div className="space-y-8">
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md dark:shadow-slate-900/50 p-6">
                <h3 className="text-xl font-semibold mb-2 dark:text-white">Individual Lessons</h3>
                <p className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">
                  {formatCurrency(individualLessonPrice)} <span className="text-lg text-gray-500 dark:text-slate-400 font-normal">/ lesson</span>
                </p>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md dark:shadow-slate-900/50 p-6">
                <h3 className="text-xl font-semibold mb-2 dark:text-white">Group Lessons</h3>
                <p className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">
                  {formatCurrency(groupLessonPrice)} <span className="text-lg text-gray-500 dark:text-slate-400 font-normal">/ lesson</span>
                </p>
                <p className="text-gray-600 dark:text-slate-300 mb-4">
            ...
            {pricingPlans.length > 0 && (
              <div className="mt-12">
                <h3 className="text-2xl font-bold mb-6 dark:text-white">Package Options</h3>
                <div className="space-y-4">
                  {pricingPlans.map((plan, index) => (
                    <div key={index} className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-slate-900/50 p-4 flex justify-between items-center">
                      <div>
                        <h4 className="font-semibold text-lg dark:text-white">{plan.name} Package</h4>
                        <p className="text-sm text-gray-600 dark:text-slate-400">{plan.lessons} lessons</p>
                      </div>
                      <div className="text-right">
                        <p className="text-primary-600 dark:text-primary-400 font-bold text-lg">{formatCurrency(plan.price)}</p>
                        {plan.discount_pct > 0 && (
                          <p className="text-green-600 dark:text-green-400 text-sm">Save {plan.discount_pct}%</p>
                        )}
                      </div>
                    </div>
                  ))}
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6 dark:text-white">Subscription Packages</h2>
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md dark:shadow-slate-900/50 p-6">
              ...
              <div className="mb-8">
                <label htmlFor="lesson-count" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                  Number of Lessons: <span className="font-bold dark:text-white">{lessonCount}</span>
                </label>
                <input
                  id="lesson-count"
                  type="range"
                  ...
                  className="w-full h-2 bg-gray-200 dark:bg-slate-600 rounded-lg appearance-none cursor-pointer dark:[&::-webkit-slider-thumb]:bg-primary-500 dark:[&::-moz-range-thumb]:bg-primary-500"
                />
              ...
              <motion.div 
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mb-6 border dark:border-slate-700 rounded-lg p-4 bg-gray-50 dark:bg-slate-700"
              >
                <h3 className="text-lg font-semibold mb-2 dark:text-white">Individual Lessons Package</h3>
                
                <div className="flex justify-between mb-2 text-gray-600 dark:text-slate-300">
                ...
                <div className="flex justify-between font-bold text-lg border-t dark:border-slate-600 pt-2 mt-2 dark:text-white">
                  <span>Total:</span>
              ...
              <motion.div 
                ...
                className="mb-6 border dark:border-slate-700 rounded-lg p-4 bg-gray-50 dark:bg-slate-700"
              >
                <h3 className="text-lg font-semibold mb-2 dark:text-white">Group Lessons Package</h3>
                ...
                <div className="flex justify-between font-bold text-lg border-t dark:border-slate-600 pt-2 mt-2 dark:text-white">
                  <span>Total:</span>
                  <span className="text-primary-600 dark:text-primary-400">{formatCurrency(groupSubscription.discountedPrice)}</span>
                </div>
      ...
      <section className="bg-gray-50 dark:bg-slate-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm dark:shadow-slate-900/50">
              <h3 className="text-lg font-semibold mb-2 dark:text-white">How long is each lesson?</h3>
              <p className="text-gray-600 dark:text-slate-300">Each lesson is 50 minutes long, allowing time for a short break between consecutive lessons.</p>
            </div>

            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm dark:shadow-slate-900/50">
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Do unused lessons expire?</h3>
              <p className="text-gray-600 dark:text-slate-300">Lesson packages are valid for 3 months from the purchase date. Any unused lessons after this period will expire.</p>
            </div>

            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm dark:shadow-slate-900/50">
              <h3 className="text-lg font-semibold mb-2 dark:text-white">How do I schedule my lessons?</h3>
              <p className="text-gray-600 dark:text-slate-300">After purchasing a package, you&apos;ll receive access to our online booking system where you can schedule lessons based on available time slots.</p>
            </div>

            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm dark:shadow-slate-900/50">
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Can I change my lesson type after purchasing?</h3>
              <p className="text-gray-600 dark:text-slate-300">You can switch between individual and group lessons, but price differences will apply. Contact us for assistance with this process.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg dark:shadow-slate-900/50 p-8 md:p-12 text-center">
